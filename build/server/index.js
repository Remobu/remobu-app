...
const { RemixServer, Meta, Links, Outlet, ScrollRestoration, Scripts, useRouteError, isRouteErrorResponse, useFetcher, useLoaderData, useNavigation, data: data$1, Link, useActionData, Form, redirect } = pkg;
import { createReadableStreamFromReadable, json, data } from "@remix-run/node";
...
import React, { useState, createContext, useContext, useEffect, useLayoutEffect, useRef, PureComponent, useCallback, useMemo, forwardRef, Component, memo, useId, useImperativeHandle, createElement, Children, isValidElement, createRef, useReducer } from "react";
...
async function handleRequest(request, responseStatusCode, responseHeaders, reactRouterContext) {
  ...
  return new Promise((resolve, reject) => {
    const { pipe, abort } = renderToPipeableStream(
      /* @__PURE__ */ jsx(RemixServer, { context: reactRouterContext, url: request.url }),
      {
        [callbackName]: () => {
...
function PublicAdvisor() {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { fontFamily: "'Segoe UI',sans-serif", background: "#F5F0E8", minHeight: "100vh", display: "flex", flexDirection: "column" }, children: [
    /* @__PURE__ */ jsxs("div", { style: { background: "#2D5233", padding: "12px 16px", display: "flex", alignItems: "center", gap: "12px" }, children: [
      /* @__PURE__ */ jsx("div", { style: { width: "44px", height: "44px", borderRadius: "50%", background: "white", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, overflow: "hidden", padding: "4px", boxSizing: "border-box" }, children: /* @__PURE__ */ jsx("img", { src: LOGO, alt: "Remobu Logo", style: { width: "100%", height: "100%", objectFit: "contain", borderRadius: "50%" } }) }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { style: { color: "#C9922A", fontWeight: "bold", fontSize: "16px", letterSpacing: "0.5px" }, children: "Remobu Farm Advisor" }),
        /* @__PURE__ */ jsx("div", { style: { color: "#F5F0E8", fontSize: "11px", fontStyle: "italic" }, children: "we're the soil" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { style: { flex: 1, padding: "16px", overflowY: "auto", display: "flex", flexDirection: "column", gap: "12px" }, children: [
      !(actionData == null ? void 0 : actionData.answer) && !isLoading && /* @__PURE__ */ jsx("div", { style: { background: "white", borderRadius: "12px", padding: "14px", borderLeft: "3px solid #C9922A" }, children: /* @__PURE__ */ jsxs("p", { style: { margin: 0, color: "#2D5233", fontSize: "14px", lineHeight: "1.6" }, children: [
        "👋 Hello! I'm your ",
        /* @__PURE__ */ jsx("strong", { children: "Remobu Farm Advisor" }),
        ". Ask me anything about farming, crops, soil health, or pests!"
      ] }) }),
      isLoading && /* @__PURE__ */ jsx("div", { style: { background: "white", borderRadius: "12px", padding: "14px", borderLeft: "3px solid #C9922A" }, children: /* @__PURE__ */ jsx("p", { style: { margin: 0, color: "#888", fontSize: "14px" }, children: "🌱 Thinking..." }) }),
      (actionData == null ? void 0 : actionData.answer) && /* @__PURE__ */ jsxs("div", { style: { background: "white", borderRadius: "12px", padding: "14px", borderLeft: "3px solid #C9922A" }, children: [
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }, children: [
          /* @__PURE__ */ jsx("div", { style: { width: "28px", height: "28px", borderRadius: "50%", background: "white", border: "1px solid #ddd", overflow: "hidden", padding: "2px", boxSizing: "border-box" }, children: /* @__PURE__ */ jsx("img", { src: LOGO, alt: "Remobu", style: { width: "100%", height: "100%", objectFit: "contain" } }) }),
          /* @__PURE__ */ jsx("span", { style: { fontWeight: "bold", color: "#2D5233", fontSize: "13px" }, children: "Remobu Advisor" })
        ] }),
        /* @__PURE__ */ jsx("p", { style: { margin: 0, color: "#333", fontSize: "14px", lineHeight: "1.7", whiteSpace: "pre-wrap" }, children: actionData.answer })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { style: { background: "white", padding: "12px", borderTop: "2px solid #2D5233" }, children: [
      /* @__PURE__ */ jsxs(
        "select",
        {
          value: language,
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("option", { value: "st", children: "🇱🇸 Sesotho" })
          ]
        }
      ),
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: "8px" }, children: [
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: isLoading ? "..." : "Ask"
          }
        )
      ] }),
      /* @__PURE__ */ jsx("p", { style: { margin: "6px 0 0", fontSize: "11px", color: "#aaa", textAlign: "center" }, children: "Enter to send • Shift+Enter for new line" })
    ] })
  ] });
}
...
async function action$2({ request }) {
  ...
  const prompt = language && language !== "en" ? `Answer in ${language}: ${question}` : question;
  const result = await model.generateContent(prompt);
...
async function loader$5({ request }) {
  ...
  `);
  const json2 = await response.json();
  const products = ((_c = (_b = (_a2 = json2 == null ? void 0 : json2.data) == null ? void 0 : _a2.products) == null ? void 0 : _b.edges) == null ? void 0 : _c.map((e) => e.node)) ?? [];
...
Farmer question: ${question}`;
  ...
  try {
    ...
    if (!((_f = (_e = (_d = agriJson.choices) == null ? void 0 : _d[0]) == null ? void 0 : _e.message) == null ? void 0 : _f.content)) throw new Error("Empty AgrILLM response");
...
function Advisor() {
  ...
  return /* @__PURE__ */ jsx(AppProvider, { i18n: enTranslations, children: /* @__PURE__ */ jsx(Page, { title: "REMOBU AI Farm Advisor", children: /* @__PURE__ */ jsxs(BlockStack, { gap: "400", children: [
    ...
    /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Text, { variant: "headingMd", children: [
...
async function loader$4({ request }) {
  ...
  return data$1({ shop: session.shop });
}
function Index() {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { padding: "20px", maxWidth: "800px", margin: "0 auto" }, children: [
    ...
    /* @__PURE__ */ jsx(Link, { to: "/app/advisor", style: { display: "block", padding: "16px", background: "#008060", color: "white", borderRadius: "8px", textDecoration: "none", fontSize: "18px", textAlign: "center" }, children: "🌱 Open AI Farm Advisor" })
  ] });
}
...
function App() {
  ...
  return /* @__PURE__ */ jsx(AppProvider$1, { isEmbeddedApp: true, apiKey, children: /* @__PURE__ */ jsx(Outlet, {}) });
}
...
const serverManifest = { "entry": { "module": "/assets/entry.client-DlC2OMpw.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/components-B9I6oKVT.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/root-B9Ol5nw7.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/components-B9I6oKVT.js"], "css": [] }, "routes/webhooks.app.scopes_update": { "id": "routes/webhooks.app.scopes_update", "parentId": "root", "path": "webhooks/app/scopes_update", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/webhooks.app.scopes_update-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/webhooks.app.uninstalled": { "id": "routes/webhooks.app.uninstalled", "parentId": "root", "path": "webhooks/app/uninstalled", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/webhooks.app.uninstalled-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/webhook.whatsapp": { "id": "routes/webhook.whatsapp", "parentId": "root", "path": "webhook/whatsapp", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/webhook.whatsapp-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/app.additional": { "id": "routes/app.additional", "parentId": "routes/app", "path": "additional", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/app.additional-DMjoPPEa.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js"], "css": [] }, "routes/public.advisor": { "id": "routes/public.advisor", "parentId": "root", "path": "public/advisor", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/public.advisor-CJxdx2k0.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/components-B9I6oKVT.js"], "css": [] }, "routes/api.advisor": { "id": "routes/api.advisor", "parentId": "root", "path": "api/advisor", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/api.advisor-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/app.advisor": { "id": "routes/app.advisor", "parentId": "routes/app", "path": "advisor", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/app.advisor-OKJwjdI5.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/components-B9I6oKVT.js", "/assets/AppProvider-BPesPWTq.js"], "css": [] }, "routes/app._index": { "id": "routes/app._index", "parentId": "routes/app", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/app._index-FUkW2B3X.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/components-B9I6oKVT.js"], "css": [] }, "routes/auth.login": { "id": "routes/auth.login", "parentId": "root", "path": "auth/login", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BI2UMo4e.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/components-B9I6oKVT.js"], "css": [] }, "routes/_index": { "id": "routes/_index", "parentId": "root", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DwY0H145.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/components-B9I6oKVT.js"], "css": ["/assets/route-Xpdx9QZl.css"] }, "routes/auth.$": { "id": "routes/auth.$", "parentId": "root", "path": "auth/*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/auth._-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/app": { "id": "routes/app", "parentId": "root", "path": "app", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/app-B4MiUkGx.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/components-B9I6oKVT.js", "/assets/AppProvider-BPesPWTq.js"], "css": ["/assets/app-CV7GIAUv.css"] } }, "url": "/assets/manifest-1a88feb3.js", "version": "1a88feb3" };
...
const routes = {
  ...
  "routes/public.advisor": {
    id: "routes/public.advisor",
    parentId: "root",
    path: "public/advisor",
    index: void 0,
    caseSensitive: void 0,
